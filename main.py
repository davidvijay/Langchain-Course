...
st.set_page_config(page_title="Lang Chain Documentation Helper", layout="centered")
st.title("Lang Chain Documentation Helper")
...
if prompt:
    ...
    with st.chat_message("assistant"):
        try:
            with st.spinner("Retreiving docs and generating answrer"):
